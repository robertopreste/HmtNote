...
class TestBcftoolsModuleOffline:
    ...
    def test_bcftools_module_annotation_offline(self,
        ...
        the module."""
        annotate(BCFTOOLS_VCF, TEST_VCF, offline=True, csv=True)
    ...
    def test_bcftools_module_annotation_offline_basic(self,
        ...
        the module."""
        annotate(BCFTOOLS_VCF, TEST_VCF, basic=True, offline=True, csv=True)
        with open(TEST_VCF) as out:
    ...
    def test_bcftools_module_annotation_offline_crossref(self,
        ...
        annotate(BCFTOOLS_VCF, TEST_VCF, crossref=True, offline=True, csv=True)
        with open(TEST_VCF) as out:
    ...
    def test_bcftools_module_annotation_offline_variab(self,
        ...
        using the module."""
        annotate(BCFTOOLS_VCF, TEST_VCF, variab=True, offline=True, csv=True)
        with open(TEST_VCF) as out:
    ...
    def test_bcftools_module_annotation_offline_predict(self,
        ...
        using the module."""
        annotate(BCFTOOLS_VCF, TEST_VCF, predict=True, offline=True, csv=True)
        with open(TEST_VCF) as out:
